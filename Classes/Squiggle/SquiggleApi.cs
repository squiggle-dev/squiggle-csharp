...
namespace Squiggle
{
    ...
    public interface ISquiggleApi
    {
        ...
        FileResponseSingle AddFile (System.IO.Stream file, string name);
        ...
        /// <param name="name"></param>
        /// <returns>FileResponseSingle</returns>
        FileResponseSingle EditFile (long? id, System.IO.Stream file, string name);
    ...
    public class SquiggleApi : ISquiggleApi
    {
        ...
        /// <param name="name"></param> 
        /// <returns>FileResponseSingle</returns>            
        public FileResponseSingle AddFile (System.IO.Stream file, string name)
        {
...
if (name != null) formParams.Add("name", ApiClient.ParameterToString(name)); // form parameter
        ...
        /// <param name="name"></param> 
        /// <returns>FileResponseSingle</returns>            
        public FileResponseSingle EditFile (long? id, System.IO.Stream file, string name)
        {
