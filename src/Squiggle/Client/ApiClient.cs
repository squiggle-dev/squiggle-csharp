...
namespace Squiggle.Client
{
    ...
    public partial class ApiClient
    {
        ...
        /// with default configuration and base path (https://api.squigglesignatures.com/v1).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://api.squigglesignatures.com/v1");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.squigglesignatures.com/v1).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.squigglesignatures.com/v1")
        {
